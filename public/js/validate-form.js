...
+(function ($) {
    ...
    var validateForm = function (elem, options) {
        ...
        this.opt = {
            ...
            tips_username: '账号格式错误',
            tips_password: '密码格式错误',
            tips_nickname: '昵称含有非法字符',
            ...
            reg_username: /^[a-zA-Z]{1}\w{5,19}$/,  //验证username
            reg_password: /^[A-Za-z0-9_]{6,20}$/,  //验证6-20位数字密码下划线组成的密码
            reg_nickname: /^[\u4e00-\u9fa5A-Za-z0-9-_]{0,10}$/,  //验证6-20位数字密码下划线组成的密码
