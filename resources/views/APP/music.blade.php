...
<nav class="topbar-fixed">
    <div class="nav-wrapper teal">
        <ul id="nav-mobile" class="left">
            ...
            <li><a href="#" class="logo-text waves-effect"> ISESAME - MUSIC</a></li>
        </ul>
    </div>
</nav>
<ul id="slide-out" class="sidenav">
    ...
    <li><a class="waves-effect" href="http://www.isesame.live/" target="_blank">个人博客</a></li>
...
<script type="text/javascript">
    ...
    function music(data) {
        ...
        document.title = music_title + " - ISESAME-MUSIC - 在线点歌";
