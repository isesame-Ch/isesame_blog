                    ...
                    <form action="#" class="form-horizontal" id="photoForm" enctype="multipart/form-data">
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-11">
                                ...
                                <div><img src="" alt="" id="upload_img" style="width: 50px;height: 50px;margin-top: 10px;display: none;"></div>
                            </div>
                        </div>
                    </form>
                    <form class="form-horizontal" role="form" id="article_form">
                        ...
                        <div class="form-group ">
                            <div class="col-sm-2 col-sm-offset-5 text-center">
                                <button type="button" id="release_btn" class="btn btn-primary btn-3d">发布文章</button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                $.ajax({
                    ...
                    success:function (data) {
                        if (data.code == 0) {
                            ...
                            $("#search_alert").removeClass("hidden");
                            let errorString = "出错喽~！"+ data.message;
                            $("#search_alert span").html("<strong>"+errorString+"</strong>");
                        }
                    },
                    error:function (e) {
                        $("#search_alert").removeClass("hidden");
